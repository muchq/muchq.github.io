...
import type { StatsAgents, StatsCountries, StatsProbes, StatsServices, TopSlugs } from '../api'

interface Props {
  hosts: HostEntry[]
  backends: ServiceEntry[]
  byDay: DayRow[]
  busiest: TopAgent[]
  fromWhere: CountryTotal[]
...
// Everything the access log can see: which vhost, which backend, which
// crawler, from where, and what they were probing for.
const TrafficTab = ({
  hosts,
  backends,
  byDay,
